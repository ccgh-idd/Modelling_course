...
window.courseData = {
  sessions: [
    { title: "Welcome and introductions", speaker: "Stefan Flasche", content: "This opening session introduces participants, faculty, and the overall structure of the short course, and provides a practical orientation to the Excel and R workflows used throughout the hands-on components.<br><br>At the end of the session the students should:<ul><li>Know the participants and faculty of the course</li><li>Understand the structure, aims and assessment of the course</li><li>Be familiar with the Excel and R workflows used in the practicals</li></ul><br><strong>Resources:</strong> <a href='assets/session%20materials/Welcome/lecture-slides.html' target='_blank'>Slides</a>" },
    ...
    { title: "Identifying a good model", speaker: "Stefan Flasche", content: "This lecture reviews what makes an infectious disease model fit for supporting public health decisions, drawing on the Lancet Commission reporting guidelines and the WHO IVIR framework.<br><br>At the end of the lecture the students should understand:<ul><li>What makes a model fit for purpose in public health decision making</li><li>The Lancet Commission reporting guidelines for transparent and reproducible modelling</li><li>How to use the WHO IVIR framework to appraise model quality and policy relevance</li></ul><br><strong>Resources:</strong> <a href='assets/session%20materials/Good%20models/lecture-slides.html' target='_blank'>Lecture Slides</a>" },
    { title: "Group work I", speaker: "Stefan Flasche", content: "Introduction to group work. Participants form groups, define topics, and start scoping their modeling question. The session sets expectations for outputs and group workflow." },
    ...
    { title: "Group work II", speaker: "Stefan Flasche & Gesine Meyer-Rath", content: "Groups discuss key insights from assigned readings and refine their project direction." },
    ...
    { title: "Group work III", speaker: "Stefan Flasche", content: "Groups prepare policy-facing presentations for the following day." },
    { title: "Group presentations", speaker: "Stefan Flasche", content: "Groups present their work in a NITAG-style discussion format. The not presenting groups will act as NITAG members and critically interact with the receommendations presented." },
    { title: "Group presentations", speaker: "Stefan Flasche", content: "Groups present their work in a NITAG-style discussion format. The not presenting groups will act as NITAG members and critically interact with the receommendations presented." },
    ...
    { title: "End of course & MC exam", speaker: "Stefan Flasche", content: "The final session closes the course, awards certificates, and summarizes key take-home messages. Participants reflect on next steps for applying methods in their own work. MSc IH students take the MC exam." }
  ],
