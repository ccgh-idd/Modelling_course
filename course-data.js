...
window.courseData = {
  sessions: [
    ...
    { title: "Practical", speaker: "David Hodgson", content: "Participants estimate age-dependent force of infection from serological data. The exercise emphasizes model assumptions, parameter interpretation, and quality checks." },
    ...
    { title: "Practical", speaker: "David Hodgson", content: "Participants infer IgG dynamics for RSV using data from The Gambia. The practical focuses on linking antibody trajectories to infection and exposure processes." },
    ...
    { title: "Practical", speaker: "David Hodgson", content: "Participants compute likelihoods and fit a simple transmission model to data. The practical focuses on implementation details and diagnostics of fit quality." },
    ...
    { title: "Practical", speaker: "David Hodgson", content: "Participants work with intentionally poorly fitting models and iteratively improve them. The exercise develops intuition for practical tuning and troubleshooting." },
    ...
    { title: "Practical", speaker: "Matej Kriznar", content: "Participants work through a simple phylogenetic modeling example. The exercise focuses on interpretation of outputs for epidemiological use." },
